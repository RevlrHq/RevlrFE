...
describe('RevenueReporting', () => {
    ...
    it('switches between tabs correctly', async () => {
        ...
        await waitFor(() => {
            expect(
                screen.getByText('Monthly Revenue Trends')
            ).toBeInTheDocument();
        });
        ...
        await waitFor(() => {
            expect(
                screen.getByText('Event Revenue Breakdown')
            ).toBeInTheDocument();
        });
        ...
        await waitFor(() => {
            expect(
                screen.getByText('Revenue Comparison & Analysis')
            ).toBeInTheDocument();
        });
        ...
        await waitFor(() => {
            expect(
                screen.getByText('Custom Report Generator')
            ).toBeInTheDocument();
        });
    });
