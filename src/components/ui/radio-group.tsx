...
>(({ className, ...props }, ref) => {
    return (
        <RadioGroupPrimitive.Item
            ...
            {...props}
        >
            <RadioGroupPrimitive.Indicator className='flex items-center justify-center rounded-full border-chit-primary'>
                {/* <Circle className='size-5 fill-current text-current' /> */}
                <span className='size-4 rounded-full bg-chit-primary'></span>
