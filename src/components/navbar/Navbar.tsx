  ...
  return (
    <header className="fixed left-0 top-0 z-50 flex h-[80px] w-full bg-white shadow-sm">
      <div className="flex w-full max-w-[1440px] items-center justify-between gap-8 px-6 py-5 md:mx-auto md:px-24">
        ...
        <nav className="hidden items-center gap-6 md:flex">
          {isOrganizer ? (
            <div className="flex w-[701px] items-center gap-16">
              <Link href="/signup" className="text-sm font-medium text-[#001433]">Sign Up</Link>
              <Link href="/how-it-works" className="text-sm font-medium text-[#001433]">How It Works</Link>
              <Link href="/events" className="text-sm font-medium text-[#001433]">Browse Events</Link>
            </div>
          ) : (
        ...
        {isOrganizer ? (
             <div className=''>
                 <Link href="/create-event" className="hidden rounded-md bg-revlr-primary px-4 py-2 text-sm font-semibold text-white md:block">Create Event</Link>
             </div>
         ) : (
             <div className="absolute inset-x-0 top-16 z-10 hidden w-full bg-white p-4 shadow-md md:static md:flex md:w-auto md:items-center md:gap-6 md:p-0 md:shadow-none">
             ...
             <Link href="/signup" className="block whitespace-nowrap font-inter text-sm font-medium text-[#001433]">Sign Up</Link>
             <Link href="/create-event" className="block whitespace-nowrap font-inter text-sm font-medium text-[#001433]">Create Event</Link>
         </div>
         )}
        </nav>
          ...
          <div className='flex flex-row gap-4 md:hidden'>
            <div>
                 <Link href="/create-event" className="rounded-md bg-revlr-primary px-4 py-2 text-sm font-semibold text-white">Create Event</Link>
             </div>

             <button className="rounded-md bg-gray-100 p-2" onClick={() => setMenuOpen(!menuOpen)}>
                {menuOpen ? <svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0.888889 11.3333H15.1111C15.6 11.3333 16 10.9333 16 10.4444C16 9.95555 15.6 9.55555 15.1111 9.55555H0.888889C0.4 9.55555 0 9.95555 0 10.4444C0 10.9333 0.4 11.3333 0.888889 11.3333ZM0.888889 6.88889H15.1111C15.6 6.88889 16 6.48889 16 6C16 5.51111 15.6 5.11111 15.1111 5.11111H0.888889C0.4 5.11111 0 5.51111 0 6C0 6.48889 0.4 6.88889 0.888889 6.88889ZM0 1.55555C0 2.04444 0.4 2.44444 0.888889 2.44444H15.1111C15.6 2.44444 16 2.04444 16 1.55555C16 1.06666 15.6 0.666664 15.1111 0.666664H0.888889C0.4 0.666664 0 1.06666 0 1.55555Z" fill="#001433"/>
                    </svg>
      ...
      {menuOpen && (
        <div className="absolute left-0 top-20 w-full bg-white p-6 shadow-md md:hidden">
          <nav className="flex flex-col gap-4">
            ...
            <Link href="/how-it-works" className="text-sm font-medium text-[#001433]">How It Works</Link>
            <Link href="/events" className="text-sm font-medium text-[#001433]">Browse Events</Link>
            <Link href="/create-event" className="rounded-md bg-revlr-primary px-4 py-2 text-center text-sm font-semibold text-white">
              Create Event
            </Link>
          </nav>
        </div>
