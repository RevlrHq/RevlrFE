    ...
    return (
        <header className='fixed left-0 top-0 z-50 flex h-[80px] w-full bg-white shadow-sm'>
            <div className='mx-auto flex max-w-[1440px] flex-row items-center justify-between gap-8 px-24 py-5'>
                ...
                {isOrganizer ? (
                    <div className='flex w-[701px] items-center justify-center gap-16'>
                        <Link
                            href='/signup'
                            className='block py-2 text-sm font-medium text-[#001433] md:py-0'
                        >
                            Sign Up
                        </Link>
                        <Link
                ...
                {isOrganizer ? (
                    <div className=''>
                        <Link
                            href='/create-event'
                            className='block rounded-md bg-revlr-primary px-4 py-2 text-sm font-semibold text-white'
                        >
                            Create Event
                        </Link>
                    </div>
                    ...
                    <div className='absolute inset-x-0 top-16 z-10 hidden w-full bg-white p-4 shadow-md md:static md:flex md:w-auto md:items-center md:gap-6 md:p-0 md:shadow-none'>
                        ...
                        <Link
                            href='/signup'
                            className='block font-inter text-sm font-medium text-[#001433]'
                        >
                            Sign Up
                        </Link>
                        <Link
