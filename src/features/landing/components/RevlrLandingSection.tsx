const RevlrLandingSection = () => {
    return (
      <section className="px-24 py-16 text-center">
        <h1 className="mb-4 text-3xl font-semibold text-[#001433]">Who Is REVLR For?</h1>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <div className="rounded-lg bg-[#F1F6FF] px-8 pb-2 pt-8">
            ...
            <h2 className="pb-3 text-xl font-semibold text-[#374252]">For Organizations & Enterprises</h2>
          ...
          <div className="rounded-lg bg-[#F1F6FF] px-8 pb-2 pt-8">
            ...
            <h2 className="pb-3 text-xl font-semibold text-[#374252]">For Individual Event Creators</h2>
            <p className="text-base font-normal text-[#6B7380]">
          ...
          <div className="rounded-lg bg-[#F1F6FF] px-8 pb-2 pt-8">
            ...
            <h2 className="pb-3 text-xl font-semibold text-[#374252]">For Attendees</h2>
            <p className="text-base font-normal text-[#6B7380]">
