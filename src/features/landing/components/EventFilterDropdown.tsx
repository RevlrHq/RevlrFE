...
interface EventFilterDropdownProps {
    onApply: (filters: { sort: string; dateRange: string; location: string; priceRange: number[]; eventType: string }) => void;
    onCancel: () => void;
  }

const EventFilterDropdown = ({onApply, onCancel} : EventFilterDropdownProps) => {
      ...
      <div className="px-4 py-6">
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            ...
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M13.825 7.91211L10 11.7288L6.175 7.91211L5 9.08711L10 14.0871L15 9.08711L13.825 7.91211Z" fill="#4C5563"/>
            </svg>
            </div>
          </div>
        </div>
        ...
        {/* Date Range */}
        <div className="mb-4">
          <label className="mb-1 block text-sm font-medium text-[#001433]">Date Range</label>
          <div className="relative">
            <select 
              value={dateRange}
        ...
        {/* Location */}
        <div className="mb-4">
          <label className="mb-1 block text-sm font-medium text-[#001433]">Location</label>
          <div className="relative">
            <select 
              value={location}
        ...
        {/* Price Range */}
        <div className="mb-8">
          <label className="mb-3 block text-sm font-medium text-[#001433]">Price Range</label>
        ...
        {/* Event Type */}
        <div className="mb-6">
          <label className="mb-2 block text-sm font-medium text-[#001433]">Event Type</label>
          <div className="space-y-2">
            <div className="flex items-center">
              ...
              />
              <label htmlFor="in-person" className="ml-2 block text-sm font-medium text-[#001433]">
                In-person
              </label>
            </div>
            <div className="flex items-center">
              <input
                ...
                className="size-4 border-gray-300 text-[#0066FF]"
              />
              <label htmlFor="virtual" className="ml-2 block text-sm font-medium text-[#001433]">
                Virtual
              </label>
            </div>
            <div className="flex items-center">
              <input
                ...
                className="size-4 border-gray-300 text-[#0066FF]"
              />
              <label htmlFor="hybrid" className="ml-2 block text-sm font-medium text-[#001433]">
                Hybrid
              </label>
            </div>
          </div>
