    ...
    return (
        <div className='mb-24 px-24 py-2'>
            <div className='relative mb-8 flex items-center justify-between pb-2'>
                <button
                    className='flex flex-row items-center gap-2 rounded-md border border-[#F2F3F5] p-2 font-inter text-[14px] font-medium text-[#374252]'
            ...
            <div className='mt-12 flex items-center justify-center space-x-2'>
                ...
                {[...Array(pagesCount)].map((_, i) => {
                    ...
                    if (!shouldShow && pageNum === currentPage + 2) {
                        return (
                            <span key={`ellipsis-after`} className='px-3 py-2'>
                                ...
                            </span>
                        );
                    }
                    ...
                    if (!shouldShow && pageNum === currentPage - 2) {
                        return (
                            <span key={`ellipsis-before`} className='px-3 py-2'>
                                ...
                            </span>
                        );
                    }
