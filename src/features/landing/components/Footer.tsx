    ...
    <footer className="flex flex-col items-center justify-center bg-gradient-to-b from-[#FFFFFF] to-[#CFE2FF] px-4 text-center md:px-24">
        ...
        <div className="flex w-full max-w-[1440px] flex-col-reverse items-center gap-8 py-2 md:flex-row md:justify-between md:py-8">
            ...
            <div className="flex flex-row gap-8">
                ...
                <path d="M11.9982 23.9817C18.6205 23.9817 23.989 18.6132 23.989 11.9908C23.989 5.36848 18.6205 0 11.9982 0C5.37581 0 0.00732422 5.36848 0.00732422 11.9908C0.00732422 18.6132 5.37581 23.9817 11.9982 23.9817Z" fill="#4C5563"/>
                <path d="M20.4805 3.5293C25.1632 8.21201 25.1634 15.8045 20.4803 20.4876C15.7973 25.1703 8.20469 25.1703 3.52197 20.4876L20.4805 3.5293Z" fill="#4C5563"/>
                <path d="M23.9115 13.3415L15.2377 4.66748L10.7342 9.17091L11.0025 9.4392L8.43848 12.003L10.5371 14.1017L10.2611 14.3776L12.5332 16.6496L9.91382 19.269L14.3885 23.7436C19.4343 22.7225 23.3292 18.5332 23.9115 13.3415Z" fill="#4C5563"/>
                <path d="M9.90173 7.53596C9.90173 7.90383 9.90173 9.54692 9.90173 9.54692H8.42847V12.006H9.90173V19.313H12.9281V12.006H14.9589C14.9589 12.006 15.1492 10.8267 15.2413 9.53765C14.9769 9.53765 12.9396 9.53765 12.9396 9.53765C12.9396 9.53765 12.9396 8.10685 12.9396 7.85612C12.9396 7.60503 13.2695 7.26706 13.5957 7.26706C13.9214 7.26706 14.6085 7.26706 15.2446 7.26706C15.2446 6.93193 15.2446 5.77528 15.2446 4.70703C14.3952 4.70703 13.4289 4.70703 13.0027 4.70703C9.82679 4.70688 9.90173 7.16829 9.90173 7.53596Z" fill="white"/>
                </g>
                <defs>
