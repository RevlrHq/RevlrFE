      ...
      <div className="flex flex-col gap-4 rounded-xl bg-[#F1F6FF] px-8 py-4 md:gap-8 md:px-48 md:py-32">
        ...
        <div className="mb-4 flex gap-3">
          ...
          <div className="text-left">
            <p className="font-inter text-[16px] font-medium text-[#374252] md:text-xl">Alex Morgan</p>
            <p className="font-inter text-sm font-normal  text-[#6B7380] md:text-lg">Event Director at SummitPro</p>
          </div>
        </div>
