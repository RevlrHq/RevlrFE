...
const FeatureComparison = () => {
    return (
        <div className='mx-auto mb-16 px-24 py-8'>
            <h2 className='mx-auto w-[530px] text-center text-3xl font-semibold text-[#001433]'>
                Plan In Minutes, Not Hours
            </h2>
            <p className='mx-auto mt-2 w-[530px] text-center text-lg font-normal text-[#4C5563]'>
                From event creation to ticketing, attendee engagement, vendor
                management and real-time insight, REVLR does it all so you can
                focus on delivering an unforgettable experience.
            </p>

            <div className='mt-8 flex flex-col md:flex-row'>
                <div className='relative flex-1 rounded-lg bg-gray-100 px-14 py-12 text-left'>
                    <span className='absolute top-[-18px] mb-4 inline-block rounded-full border border-[#E4E6EB] bg-[#FFFFFF] p-2 text-sm font-semibold'>
                ...
                <div className='relative flex-1 rounded-lg bg-[#FFD70033] px-14 py-12 text-left'>
                    <span className='absolute top-[-18px] mb-4 inline-block rounded-full border border-[#6B7380] bg-[#FFFDF0] p-2 text-sm font-semibold'>
                    ...
                    <ul className='mt-4 space-y-6 text-lg font-medium text-[#001433]'>
                        {[
                            ...
                            <li key={index} className='flex items-center gap-2'>
                                ...
                                >
                                    <path
                                        d='M9.00002 0.666748C4.40002 0.666748 0.666687 4.40008 0.666687 9.00008C0.666687 13.6001 4.40002 17.3334 9.00002 17.3334C13.6 17.3334 17.3334 13.6001 17.3334 9.00008C17.3334 4.40008 13.6 0.666748 9.00002 0.666748ZM6.74169 12.5751L3.75002 9.58341C3.42502 9.25841 3.42502 8.73341 3.75002 8.40841C4.07502 8.08341 4.60002 8.08341 4.92502 8.40841L7.33335 10.8084L13.0667 5.07508C13.3917 4.75008 13.9167 4.75008 14.2417 5.07508C14.5667 5.40008 14.5667 5.92508 14.2417 6.25008L7.91669 12.5751C7.60002 12.9001 7.06669 12.9001 6.74169 12.5751Z'
                                        fill='#B59900'
                                    />
                                </svg>
                                {item}
