    ...
    return (
        <div className='mb-16 px-4 py-8 md:mx-auto md:px-24'>
            <h2 className='mx-auto w-full text-center font-montserrat text-xl font-semibold leading-7 text-[#001433] md:w-[660px] md:text-[32px] md:leading-[40px]'>
                From Idea to Sold-Out Even, Fast! Create & Manage Events in 3
                Easy Steps
            </h2>
                ...
                <div className='w-full md:w-[465px]'>
                    <div className='mb-12 flex flex-col'>
                        {[
                            ...
                            {
                                step: 2,
                                title: '2. Engage Your Audience',
                                description:
                                    'Automate invitations, RSVPs and reminders to keep attendees informed.',
                            },
                            {
                                step: 3,
                                title: '3. Sell & Manage Effortlessly',
                                description:
                                    'Monitor real-time analytics to optimise attendance, engagement and overall event success.',
                            },
                            ...
                            <div
                                ...
                                className={`flex cursor-pointer flex-col gap-2 px-5 py-4 transition-all md:gap-4 md:py-6 ${
                                    selectedStep === step
                                        ? 'border-l-4 border-[#FFD700] bg-[#FFD7000D]'
                                        : ''
                                }`}
                            >
                                <div className='font-inter text-base font-semibold text-[#1F2938] md:text-xl'>
                                    {title}
                                </div>
