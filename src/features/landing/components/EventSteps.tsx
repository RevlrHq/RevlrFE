          ...
          <div className="w-[465px]">
              <div className="mb-12 flex flex-col">
                <div className="flex flex-col gap-4 border-l-4 border-[#FFD700] bg-[#FFD7000D] px-5 py-6">
                    <div className="text-[20px] font-semibold text-[#1F2938]">1. Enter Event Details </div>
                    <p className="text-lg font-normal text-[#6B7380]">Add key info and select ticket types in minutes.</p>
                </div>

                <div className="flex flex-col gap-4 px-5 py-6">
                    <div className="text-[20px] font-semibold text-[#1F2938]">2. Engage Your Audience</div>
                    <p className="text-lg font-normal text-[#6B7380]">Automate invitations, RSVPs and reminders to keep attendees informed.</p>
                </div>

                <div className="flex flex-col gap-4 px-5 py-6">
                  <div className="text-[20px] font-semibold text-[#1F2938]">3. Sell & Manage Effortlessly</div>
                  <p className="text-lg font-normal text-[#6B7380]">Monitor real-time analytics to optimise attendance, engagement and overall event success.</p>
                </div>
              </div>
